 ...
 */
public class AppJPParallelFull {
    private static final Logger log = Logger.getLogger(AppJPParallelFull.class);
    ...
    public static void main(String[] args) {
        String query =
                ...
                + "begin"
                + "\tfrom inputStream#window.time(10 sec) as a full outer join secondStream#window.length(10) "
                + "as b \n"
