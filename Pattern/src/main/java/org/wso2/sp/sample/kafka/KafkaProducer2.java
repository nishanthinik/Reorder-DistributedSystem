...
public class KafkaProducer2 extends Thread {
    ...
    KafkaProducer2(LinkedBlockingQueue<String> messagesList, String topicName) {
        ...
        if (!"".equalsIgnoreCase("0001")) {
            ...
            try {
                ...
                while (true) {
                    ...
                    log.info(
                            "Sending " + message + " on topic: " + topicName + " to partition: " + "0");
                    Thread.sleep(1);
                    producer2.send(new ProducerRecord<>(topicName, 0, "Producer 2", message));
                }
